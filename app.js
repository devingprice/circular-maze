...
maze
params
    current = x, y, maze, hallwayThickness, outerradius

    maze (vertical walls + horizontal walls) (generate using function inside class)
    width, height (x, y = half respectively [OR keep viewbox 1000 and half is always 500])
    line thickness
    numHallways
    inner radius, outer radius (inner radius + outerradius + num hallways = hallwayThickness)
*/
